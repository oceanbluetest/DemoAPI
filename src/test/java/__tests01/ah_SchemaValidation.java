...
public class ah_SchemaValidation {
    ...
    void test01(){
        ...
        assertThat(responseBody, matchesJsonSchemaInClasspath("data/jsonSchema/sdetCourseSchema.json"));
    ...
    void test02(){
        given()
                ...
                .get("https://tla-school-api.herokuapp.com/api/school/programs/sdetcourse")
                .then()
                .body(matchesJsonSchemaInClasspath("data/jsonSchema/sdetCourseSchema.json"));
    }
    ...
    void test03(){
        given()
                ...
                .then()
                .body(matchesJsonSchemaInClasspath("data/jsonSchema/gorestSchema.json"))
        .log().body();
    }
}
